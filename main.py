...
def analysis(args):
    file_name = args[args.index('-n') + 1] if '-n' in args else ""
    print(f"Analyzing file {file_name}...")
    analyze_and_predict(file_name)
def help():
    print("Instructions:")
    print("auto  [-f filename]")
    print("scan -name [namespace]")
    print("map  [-f filename]")
    print("analysis -n [filename]")
    print("help")
    print("about")
    print("exit")

def about():
    print("About me ASCII art...")  # Replace with your ASCII art
